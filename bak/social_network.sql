...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2016 at 02:24 AM
...
(1, '', 'Yu-Kai', 'Huang', 22, 'cupertino', 'California', 'Student'),
(3, '', 'wen', 'Huang', 23, 'cupertino', 'California', 'None'),
(4, '', 'wen', 'Huang', 23, 'cupertino', 'California', 'None'),
(5, '', 'jack', 'smith', 33, 'oug', 'omg', 'None'),
(6, '', 'aa', 'bb', 3, 'w', 'x', 'None');
...
--
ALTER TABLE `profile`
  MODIFY `ProfileID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
